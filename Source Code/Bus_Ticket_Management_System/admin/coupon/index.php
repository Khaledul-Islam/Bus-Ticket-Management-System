        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a class="alert-danger" href="index.php"><i class="fa fa-credit-card fa-2x"></i> Coupons</a>
                    </li>
                    <li>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <a class="btn btn-primary" href="generate_coupon.php">Generate Coupon</a>
                                </div>
                                <div class="table-responsive">
                                    <table class="table">
                                        <thead>
                                        ...
                                        for($i=0; $i < count(Coupon::get_all_coupons()); $i++){

                                            //echo    var_dump(Bus::get_all_buses());

                                            echo "<tr>";

                                            echo "<td>".Coupon::get_all_coupons()[$i]['id']."</td>";
                                            echo "<td>".Coupon::get_all_coupons()[$i]['code']."</td>";
                                            echo "<td>".Coupon::get_all_coupons()[$i]['value']."</td>";
                                            echo "<td>".Coupon::get_all_coupons()[$i]['is_redeemed']."</td>";
