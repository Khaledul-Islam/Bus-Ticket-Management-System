...
include_once('information_controller.php');
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a class="alert-danger" href="index.php"><i class="fa fa-info fa-2x"></i> Information</a>
                    </li>
                    <li>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <a class="btn btn-primary" href="post_information.php">Post Information</a>
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        for($i=0; $i < count(Information::get_all_informations()); $i++){
                                            ...
                                            echo "<div class='panel panel-default'>";
                                                ...
                                                if ($img!=null) {
                                                    echo "<img class=\"thumbnail\" style=\"max-width:30%;max-height:30%; float:right;\" src=\"../../upload/".$img."\" />";
                                                }
                                                echo "</div>";
                                                echo"<div class='panel-footer'>";
                                                echo " <a class='btn btn-danger' data-toggle='modal' data-target='#myModal".$i."' >Delete Info</a> ";
                                                echo "</div>";
  ...
  <div class='modal-dialog' role='document'>
    <div class='modal-content'>
      ...
      <div class='modal-footer'>
        <a href='information_controller.php?type=delete&information_id=".Information::get_all_informations()[$i]['id']."' class='btn btn-danger'>Yes</a>
