        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    <li>
                        <a class="alert-danger" href="index.php"><i class="fa fa-dashboard fa-2x"></i> Dashboard</a>
                    </li>
                    <li>
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?php echo count(Driver::get_all_drivers()); ?></div>
                                    <div>Drivers</div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-green">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?php echo count(Bus::get_all_buses()); ?></div>
                                    <div>Buses</div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-yellow">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?php echo count(Route::get_all_routes()); ?></div>
                                    <div>Routes</div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-red">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?php echo count(User::get_all_users()); ?></div>
                                    <div>Users</div>
                                </div>
                            </div>
                        </div>
