        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a  class="alert-danger" href="index.php"><i class="fa fa-bar-chart-o fa-2x"></i> Reports</a>
                    </li>
                </ul>
            </div>
            <!-- /.sidebar-collapse -->
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <a class="btn btn-primary" href="view_weekly.php">Weekly Report</a>
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    for($i=0; $i < count(Action::get_all_actions()); $i++){

                                        echo "<div class='panel panel-default'>";
                                        echo "<div class='panel-heading'>";
                                        echo " ".Action::get_all_actions()[$i]['type']." ";
                                        echo "</div>";
                                        echo"<div class='panel-body'>";
                                        echo " ".Action::get_all_actions()[$i]['action']." ";
                                        echo "</div>";
                                        echo"<div class='panel-footer'>";
                                        $time = Action::get_all_actions()[$i]['date'];
                                        echo " ".getdate($time)['weekday']." - ".getdate($time)['month']." ".getdate($time)['mday'].", ".getdate($time)['year']." - ".getdate($time)['hours'].":".getdate($time)['minutes'].":".getdate($time)['seconds']." ";
                                        echo "</div>";
