...
include_once('driver_controller.php');
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a class="alert-danger" href="index.php"><i class="fa fa-user fa-2x"></i> Drivers</a>
                    </li>
                    <li>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <form method="get" role="form" action="driver_controller.php" enctype="multipart/form-data">
                                ...
                                <div class="table-responsive">
                                    <a class="btn btn-primary" href="add_driver.php">Add Driver</a>
                                </div>
                                <div class="table-responsive">
                                    <table class="table">
                                        <thead>
                                        ...
                                        for($i=0; $i < count(Driver::get_all_drivers()); $i++){
                                            ...
                                            echo "<td>".Driver::get_all_drivers()[$i]['id']."</td>";
                                            echo "<td>".Driver::get_all_drivers()[$i]['name']."</td>";
                                            echo "<td>".Driver::get_all_drivers()[$i]['phone_number']."</td>";
                                            echo "<td>".Driver::get_all_drivers()[$i]['is_assigned']."</td>";
                                            echo "<td><a class='btn btn-danger' data-toggle='modal' data-target='#myModal".$i."' >Delete Driver</a></td>";
  ...
  <div class='modal-dialog' role='document'>
    <div class='modal-content'>
      ...
      <div class='modal-footer'>
        <a href='driver_controller.php?type=delete&driver_id=".Driver::get_all_drivers()[$i]['id']."' class='btn btn-danger'>Yes</a>
