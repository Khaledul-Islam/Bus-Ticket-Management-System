            ...
            <div class="container">
               ...
               <div id="navbar" class="navbar-collapse collapse navbar-right">
                    <ul class="nav navbar-nav">
                             <h2 style="font-size: 17px;margin-top: 0px;" class="navbar-brand brand-name">
                        <a href="index.php"><img style="max-width:150px; margin-top:-20px; ">Bus Ticket Management System</a></h2>
                        ...
                        <?php if(isset($_SESSION['user_id']) && $_SESSION['user_type'] == 'user'){
                            ...
                            echo '<li><a href="user/coupon/claim_coupon.php">Balance</a></li>';
                        }?>
...
<div class="container marketing">
    ...
    <div class="row featurette">
        <div class="col-lg-7">
            <h1>Comment Form</h1>
            <form method="get" role="form" action="admin/comment/comment_controller.php" enctype="multipart/form-data">
                <?php

                    if(isset($_SESSION['user_id'])){
                        $user = User::get_user_by_id($_SESSION['user_id']);
                        echo "<input type='hidden' name='full_name' value='".$user['first_name']." ".$user['last_name']."'>";
                    }
                    else{
                        echo "<div class='form-group'>
                    <label>Full Name</label>
                    <input name='full_name' type='text' class='form-control' placeholder='Enter Full Name' required>
                </div>";
                    }
                ?>
                ...
                <div class="form-group">
                    <label>Comment</label>
                    <textarea name="comment" rows="7" class="form-control" placeholder="Type Comment Here..." required></textarea>
                </div>
        ...
        <div class="col-md-5">
            <img class="featurette-image img-responsive center-block" src="images/contact_bus.jpg"  alt="Generic placeholder image">
        </div>
    </div>
   ...
   <footer class="tm-black-bg">
        <div class="container">
                ...
                <p class="tm-copyright-text">Copyright &copy; 2019 SHUVO 
                        ...
                        <div class="modal-body">
                            <form method="get" role="form" action="register_controller.php" enctype="multipart/form-data">
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-group">
                                                <label>ID</label>
                                                <input name="kebele_id" type="text" class="form-control" placeholder="Enter ID" required>
                                            </div>
                                            <div class="form-group">
                                                <label>Gender</label>
