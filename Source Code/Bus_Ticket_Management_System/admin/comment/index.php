        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a class="alert-danger" href="index.php"><i class="fa fa-comments-o fa-2x"></i> Comments</a>
                    </li>
                    <li>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        for($i=0; $i < count(Comment::get_all_comments()); $i++){

                                            echo "<tr>";

                                            echo "<td>".Comment::get_all_comments()[$i]['id']."</td>";
                                            echo "<td>".Comment::get_all_comments()[$i]['user']."</td>";
                                            echo "<td>".Comment::get_all_comments()[$i]['comment']."</td>";
