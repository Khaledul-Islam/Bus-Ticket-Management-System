                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        for($i=0; $i < count(User::get_all_users()); $i++){
                                            ...
                                            echo "<td>".User::get_all_users()[$i]['username']."</td>";
                                            echo "<td>".User::get_all_users()[$i]['first_name']."</td>";
                                            echo "<td>".User::get_all_users()[$i]['last_name']."</td>";
                                            echo "<td>".User::get_all_users()[$i]['kebele_id_number']."</td>";
                                            echo "<td>".Balance::get_user_balance(User::get_all_users()[$i]['id'])['amount']."</td>";
                                            echo "<td>".User::get_all_users()[$i]['status']."</td>";
                                            if(User::get_all_users()[$i]['status'] == 'active'){

                                                echo "<td><a class='btn btn-danger' href='user_controller.php?type=deactivate&user_id=".User::get_all_users()[$i]['id']."'>Deactivate</a></td>";
                                            } else{

                                                echo "<td><a class='btn btn-success' href='user_controller.php?type=reactivate&user_id=".User::get_all_users()[$i]['id']."'>Reactivate</a></td>";
                                            }
                                            echo "<td><a class='btn btn-danger' data-toggle='modal' data-target='#myModal".$i."'  >Delete User</a></td>";
  ...
  <div class='modal-dialog' role='document'>
    <div class='modal-content'>
      ...
      <div class='modal-footer'>
        <a href='user_controller.php?type=delete&user_id=".User::get_all_users()[$i]['id']."' class='btn btn-danger'>Yes</a>
