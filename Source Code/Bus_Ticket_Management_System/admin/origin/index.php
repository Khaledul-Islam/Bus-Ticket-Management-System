...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Origin List</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <a class="btn btn-primary" href="add_origin.php">Add Origin</a>
                                </div>
                                <div class="table-responsive">
                                    <table class="table">
                                        <thead>
                                        ...
                                        for($i=0; $i < count(Origin::get_all_origins()); $i++){

                                            echo "<tr>";

                                            echo "<td>".Origin::get_all_origins()[$i]['id']."</td>";
                                            echo "<td>".Origin::get_all_origins()[$i]['name']."</td>";
  ...
  <div class='modal-dialog' role='document'>
    <div class='modal-content'>
      ...
      <div class='modal-footer'>
        <a href='origin_controller.php?type=delete&origin_id=".Origin::get_all_origins()[$i]['id']."' class='btn btn-danger'>Yes</a>
