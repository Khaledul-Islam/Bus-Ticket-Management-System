...
include_once('destination_controller.php');
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a class="alert-danger" href="index.php"><i class="fa fa-anchor fa-2x"></i> Destinations</a>
                    </li>
                    <li>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <a class="btn btn-primary" href="add_destination.php">Add Destination</a>
                                </div>
                                <div class="table-responsive">
                                    <table class="table">
                                        <thead>
                                        ...
                                        for($i=0; $i < count(Destination::get_all_destinations()); $i++){

                                            echo "<tr>";

                                            echo "<td>".Destination::get_all_destinations()[$i]['id']."</td>";
                                            echo "<td>".Destination::get_all_destinations()[$i]['name']."</td>";
                                            echo "<td><a class='btn btn-danger' data-toggle='modal' data-target='#myModal".$i."' >Delete</a></td>";
  ...
  <div class='modal-dialog' role='document'>
    <div class='modal-content'>
      ...
      <div class='modal-footer'>
        <a href='destination_controller.php?type=delete&destination_id=".Destination::get_all_destinations()[$i]['id']."' class='btn btn-danger'>Yes</a>
